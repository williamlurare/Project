...
class Header extends Component {
    ...
    render(){
      ...
      <div className="container">
        ...
        <NavbarBrand className="mr-auto" href="/"><img src="assets\images\logo.png" height="30" width="41" alt="FirstTime">
            </img>
            </NavbarBrand>
...
=======
        ...
        <ModalBody>
>>>>>>> 594259660650c62e6f595d972052b17a9a759d8b
            <Form onSubmit={this.handleLogin}>
                ...
                <Button type="submit" value="submit" className="bg-success"> Login
                </Button>
            </Form>
        </ModalBody>
    </Modal>
