                ...
                <div className="row row-content">
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                              <Label htmlFor="firstname" md={2} >First Name: </Label>  
                                <Col md={10}>
                                    ...
                                    maxLength: maxLength(20), isCharacter}}/>
                            ...
                            <Row className="form-group">
                              <Label htmlFor="telno" md={2} >Tel. Number: </Label>  
                                <Col md={10}>
                                    <Control.text model=".telno" type="tel" id="telno" name="telno" 
                                    placeholder="Telephone Number" 
                                    className="form-control"
                                    validators={{required, minLength: minLength(10), 
                                        maxLength: maxLength(10), isNumber }}/>
                                       
                                       <Errors className="text-danger" model=".telno" 
                                    show="touched" 
                                    messages={{required: 'Required',
                                               minLength: 'Must Be 10 characters',
                                               maxLength: 'Must Be 10 characters',
                                               isNumber: 'Invalid characters'
                            ...
                            <Row className="form-group">
                              <Label htmlFor="email" md={2} >Email: </Label>  
                                <Col md={10}>
                                    <Control.text model=".email" type="emial" id="email" name="email" 
                                    placeholder="Email" 
                                    className="form-control"
