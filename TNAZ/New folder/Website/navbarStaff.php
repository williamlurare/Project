          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav gabali">
                <li><a href="staff.php">Driver's Log</a></li>
                <li><a href="bookingformStaff.php">Log</a></li>
              <!--  <li><a href="schedule.php">Bus Schedule</a></li> -->
                <li><a href="mystaffprofile.php?id=<?php echo $_SESSION['driverid']; ?>">My Account</a></li>
