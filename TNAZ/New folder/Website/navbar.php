          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
              <ul class="nav navbar-nav gabali">
                ...
                <li><a href="bookingform.php">Booking list</a></li>
              <!--  <li><a href="schedule.php">Bus Schedule</a></li> -->
                <li><a href="myprofile.php?id=<?php echo $_SESSION['username']; ?>">My Account</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="index1.php"><span class="glyphicon glyphicon-log-in"></span> Home Page </a></li>
              </ul>
            </div> 
