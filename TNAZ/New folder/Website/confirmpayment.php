        ...
        <div class="row">
           <div class="page-header">
            ...
            <div class="col-md-6">
                  ...
                  <p><strong>Oil Cost: </strong><?php echo isset($row['oil_cost']); ?></p>    
                  <p><strong>Extra Cost: </strong><?php echo isset($row['extra_cost']); ?></p>    
                  <p><strong>Total Cost: </strong><?php echo isset($row['total_cost']); ?></p>
