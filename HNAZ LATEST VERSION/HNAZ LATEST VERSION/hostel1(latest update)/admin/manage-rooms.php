...
<head>
	...
	<title>Manage Hostel/Room</title>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<h2 class="page-title"></h2>
						<h2 class="page-title">Manage Hostel/Room</h2>
						<div class="panel panel-default">
							<div class="panel-heading">All Hostel/Room Details</div>
